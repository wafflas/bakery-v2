...
export default function ProductsClient() {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Products Animation - triggers almost immediately when entering viewport
      if (productsRef.current) {
        gsap.fromTo(
          productsRef.current,
          { opacity: 0, y: 21, scale: 0.98 },
          {
            opacity: 1,
            y: 0,
            scale: 1,
      ...
      <section className="mt-20 text-center">
        <div className="bg-gradient-to-r from-red-600 to-red-800 rounded-3xl p-8 md:p-12 text-white">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Επισκεφθείτε τα καταστήματά μας για να δοκιμάσετε τα φρέσκα προϊόντα
            μας ή παραγγείλετε μέσω Wolt για παράδοση στο σπίτι
          </p>
